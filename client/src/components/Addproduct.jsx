...
export default function Addproduct() {
  const [formData, setFormData] = useState({
    name: "", price: "", description: "", image: "", category: "other"
  })
          ...
          <div className="col-md-7 col-lg-6">
            <div className="card border-0 shadow-sm" style={{ borderRadius: "20px", overflow: "hidden" }}>
              ...
              >
                ...
                <p className="mb-0 opacity-75 small">Fill in the product details below</p>
              </div>
              ...
              <div className="card-body p-4">
                ...
                <form onSubmit={handleAddProduct}>
                  ...
                  <div className="mb-3">
                    <label className="form-label fw-semibold text-muted small">Price (₹)</label>
                    <div className="input-group">
                      <span
                        className="input-group-text"
                        style={{ borderRadius: "10px 0 0 10px", border: "2px solid #e9ecef", borderRight: 0, background: "#f8f9fa" }}
                      >₹</span>
                      <input
                        type="number"
                        name="price"
                        ...
                        placeholder="0.00"
                        min="0"
                        style={{ borderRadius: "0 10px 10px 0", border: "2px solid #e9ecef", borderLeft: 0 }}
                        onChange={handleChange}
                        required
                      />
                    </div>
                  ...
                  <div className="mb-4">
                    <label className="form-label fw-semibold text-muted small">Image URL</label>
                    <input
                      type="url"
                      name="image"
                      className="form-control py-2"
                    ...
                    {formData.image && (
                      <div className="mt-2 text-center">
                        <img
                          src={formData.image}
                          alt="Preview"
                          style={{ height: "120px", objectFit: "cover", borderRadius: "10px", border: "2px solid #e9ecef" }}
